      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="border border-white/10 bg-[#141211] p-8">
            <div className="font-mono text-xs tracking-[0.3em] uppercase text-[#FACC15] mb-2">Prologue</div>
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              {err && <div data-testid="register-error" className="text-[#EF4444] font-mono text-xs">{err}</div>}
              <button
                type="submit"
                disabled={loading}
            ...
            <div className="mt-6 text-center font-mono text-xs tracking-widest text-[#99958E]">
              Already a regular?{" "}
              <Link to="/login" className="text-[#FACC15] hover:text-[#FDE047]" data-testid="register-to-login-link">
                Walk right in
              </Link>
            </div>
          </div>
