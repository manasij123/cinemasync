      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="border border-white/10 bg-[#2a2a2a] p-8">
            <div className="font-mono text-xs tracking-[0.3em] uppercase text-[#6a14ff] mb-2">Act I · Entry</div>
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div>
                <label className="font-mono text-[10px] tracking-[0.3em] uppercase text-[#cccccc] block mb-2">Password</label>
                <input
                  type="password"
                  required
                  value={password}
              ...
              {err && <div data-testid="login-error" className="text-[#ffd100] font-mono text-xs">{err}</div>}
              <button
                type="submit"
                disabled={loading}
            ...
            <div className="mt-6 text-center font-mono text-xs tracking-widest text-[#cccccc] space-y-2">
              <div>
                <Link to="/forgot-password" className="text-[#6a14ff] hover:text-[#5a0fd6]" data-testid="login-to-forgot-link">
                  Forgot password?
                </Link>
              </div>
              <div>
                New here?{" "}
                <Link to="/register" className="text-[#6a14ff] hover:text-[#5a0fd6]" data-testid="login-to-register-link">
                  Book a seat
                </Link>
              </div>
            </div>
