...
const PLATFORMS = [
  ...
  { id: "custom", label: "Custom", hint: "any url", color: "#E5A93C" },
];
  ...
  return (
    <div className="border border-white/10 bg-[#141211] p-6" data-testid="create-room-card">
      <div className="flex items-center gap-2 mb-5">
        <Plus size={16} className="text-[#E5A93C]" />
        <span className="font-mono text-xs tracking-[0.3em] uppercase text-[#E5A93C]">Host a screening</span>
      </div>
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button
          ...
          className="w-full bg-[#E5A93C] text-[#0A0908] font-mono tracking-[0.25em] uppercase text-sm px-6 py-4 hover:bg-[#F0B955] disabled:opacity-60"
        >
...
function JoinRoom({ onJoined }) {
  ...
  return (
    <div className="border border-white/10 bg-[#141211] p-6" data-testid="join-room-card">
      <div className="flex items-center gap-2 mb-5">
        <DoorOpen size={16} className="text-[#E5A93C]" />
        <span className="font-mono text-xs tracking-[0.3em] uppercase text-[#E5A93C]">Crash a screening</span>
      </div>
      ...
      <form onSubmit={submit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-[#0A0908] border border-white/10 focus:border-[#E5A93C] px-4 py-3 font-mono tracking-widest uppercase"
          />
        </div>
        <div>
          <label className="font-mono text-[10px] tracking-[0.3em] uppercase text-[#99958E] block mb-2">Password</label>
        ...
        <button
          ...
          className="w-full border border-white/20 text-[#F7F7F2] font-mono tracking-[0.25em] uppercase text-sm px-6 py-4 hover:border-[#E5A93C] hover:text-[#E5A93C] disabled:opacity-60"
        >
    ...
    <div>
      ...
      <main className="max-w-[1400px] mx-auto px-6 md:px-10 py-10">
        ...
        <section className="mb-10" data-testid="dashboard-greeting">
          <div className="font-mono text-xs tracking-[0.3em] uppercase text-[#E5A93C] mb-3">House Lights Dim</div>
          ...
          <aside className="lg:col-span-4 space-y-6">
            <div className="border border-white/10 bg-[#141211] p-6">
              <div className="flex items-center justify-between mb-4">
                <span className="font-mono text-xs tracking-[0.3em] uppercase text-[#E5A93C]">Friends</span>
                <Link to="/friends" data-testid="dashboard-manage-friends-link" className="font-mono text-[10px] tracking-widest uppercase text-[#99958E] hover:text-[#E5A93C]">Manage</Link>
              </div>
                ...
                <ul className="space-y-3" data-testid="dashboard-friends-list">
                  {friends.slice(0, 5).map((f) => (
                    <li key={f.id} className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-[#E5A93C]/20 border border-white/10 flex items-center justify-center font-head text-sm">
            ...
            <div className="border border-white/10 bg-[#141211] p-6">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-mono text-xs tracking-[0.3em] uppercase text-[#E5A93C]">Requests</span>
              </div>
