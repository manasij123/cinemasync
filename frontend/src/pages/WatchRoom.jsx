...
function VoiceTile({ self = false, name, stream, videoRef, hasVideo, hasAudio }) {
  ...
  return (
    <div
      ...
      className="relative w-36 h-24 bg-black/80 border border-white/20 rounded-md overflow-hidden shadow-[0_6px_20px_rgba(0,0,0,0.55)]"
    >
      {hasVideo ? (
        <video
          ref={targetRef}
        ...
        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#6a14ff] to-[#2a2a2a]">
      ...
      <div className="absolute bottom-0 left-0 right-0 px-2 py-1 flex items-center justify-between bg-gradient-to-t from-black/80 to-transparent">
        ...
        <span className="flex items-center gap-1">
          {hasAudio ? (
            ...
            <MicOff size={10} className="text-[#ffd100]" />
          )}
        </span>
      </div>
    </div>
...
export default function WatchRoom() {
  ...
  if (!room) {
    return (
      <div>
        <Navbar />
        <div className="p-10 font-mono text-xs tracking-[0.3em] uppercase text-[#cccccc]" data-testid="room-loading">Loading…</div>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <main className="max-w-[1600px] mx-auto px-4 md:px-6 py-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 mb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-mono text-[10px] tracking-[0.3em] uppercase text-[#6a14ff] mb-1 flex items-center gap-2">
                <span className="w-2 h-2 bg-[#ffd100] pulse-live" /> Live · {PLATFORM_LABEL[room.platform]}
              </div>
              <h1 className="font-head text-2xl sm:text-3xl uppercase leading-none" data-testid="watch-room-name">{room.name}</h1>
            </div>
          </div>
          <div className="flex flex-wrap gap-2">
            <div className="font-mono text-[10px] tracking-widest uppercase text-[#cccccc] px-3 py-2 border border-[#6a14ff]/30 bg-white">
              Room: <span className="text-[#6a14ff]">{roomId}</span>
            </div>
            {isHost && (
              <button
                onClick={endRoom}
                data-testid="watch-end-room-button"
                className="border border-[#ffd100]/60 text-[#ffd100] font-mono text-xs tracking-widest uppercase px-4 py-2 hover:bg-[#ffd100] hover:text-white transition-colors"
            ...
            <button
              ...
              className="border border-[#6a14ff]/45 font-mono text-xs tracking-widest uppercase px-4 py-2 hover:border-[#ffd100] hover:text-[#ffd100]"
            >
              Exit
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <section
            ...
            className={
              ...
              (fullscreen
                ...
                : "bg-[#2a2a2a] border-[#6a14ff]/30 lg:col-span-3 h-[55vh] sm:h-[62vh] lg:h-[78vh]")
            }
          >
            <div className="flex-1 relative flex items-center justify-center">
              ...
              <video
                ...
                autoPlay
                playsInline
                className={`w-full h-full object-contain bg-[#000000] ${sharing || remoteSharerId ? "block" : "hidden"}`}
              ...
              {remoteSharerId && !sharing && needsAudioTap && (
                <button
                  ...
                  className="absolute top-3 right-3 bg-[#ffd100] text-black px-3 py-1.5 font-mono text-[10px] tracking-[0.25em] uppercase hover:bg-[#e8bd00] z-10 shadow-lg animate-pulse"
              ...
              <button
                ...
                className={
                  ...
                  (fullscreen
                    ...
                    : "bg-[#2a2a2a]/95 border-[#6a14ff] text-[#ffffff] hover:bg-[#6a14ff]/20") +
              ...
              {!sharing && !remoteSharerId && !fullscreen && !(room.platform === "custom" && customIframeSrc) && (
                <div className="text-center px-6 max-w-xl w-full">
                  ...
                  <div className="font-head text-3xl sm:text-5xl uppercase text-[#6a14ff] mb-3">Intermission</div>
                  {room.platform === "custom" ? (
                    <>
                      <p className="text-[#cccccc] max-w-md mx-auto mb-5">
                      ...
                      {isHost ? (
                        ...
                        >
                          <input
                            ...
                            className="flex-1 min-w-0 bg-white border border-[#3a3a3a] focus:border-[#ffd100] rounded-lg px-3 py-2 text-sm"
                          />
                          <button
                            type="submit"
                            data-testid="watch-custom-launch-button"
                            className="bg-[#ffd100] text-black font-mono text-xs tracking-[0.2em] uppercase px-4 py-2 rounded-lg hover:shadow-[0_8px_20px_rgba(255,209,0,0.35)]"
                          >
                            Launch here
                          </button>
                        </form>
                      ) : (
                        <p className="font-mono text-[10px] tracking-widest uppercase text-[#888888]">
                    ...
                    <>
                      <p className="text-[#cccccc] max-w-md mx-auto mb-6">
                        Open <span className="font-mono text-[#6a14ff]">{PLATFORM_LABEL[room.platform]}</span> in a new tab and hit play — your room syncs the timer.
                      ...
                      <div className="flex justify-center gap-3 flex-wrap">
                        <button
                          ...
                          className="inline-flex items-center gap-2 border border-[#6a14ff]/45 font-mono text-xs tracking-widest uppercase px-4 py-3 hover:border-[#6a14ff] hover:text-[#6a14ff]"
                        >
              ...
              {remoteSharerId && !sharing && (
                <div className="absolute top-3 left-3 px-3 py-1.5 bg-[#2a2a2a]/80 border border-[#6a14ff]/40 text-[#6a14ff] font-mono text-[10px] tracking-[0.25em] uppercase">
            ...
            <div className={
              ...
              <button
                ...
                className="text-[#ffffff] hover:text-[#6a14ff] disabled:opacity-40 disabled:hover:text-[#ffffff]"
                title="-10s"
              >
                <SkipBack size={20} />
              </button>
              <button
                ...
                className="w-10 h-10 sm:w-11 sm:h-11 bg-[#6a14ff] text-[#ffffff] flex items-center justify-center hover:bg-[#5a0fd6] disabled:opacity-40 disabled:hover:bg-[#6a14ff]"
              ...
              <div className="w-px h-8 bg-[#6a14ff]/15" />
              <div className="font-mono text-xs tracking-widest text-[#ffffff]" data-testid="sync-timer">
                {fmtTime(position)}
              </div>
              {isHost && (
                <>
                  ...
                  <button
                    ...
                    className="text-[#cccccc] hover:text-[#6a14ff]"
                    title="Reset timer"
                  >
                    <RotateCcw size={16} />
                  </button>
              ...
              {isHost ? (
                !sharing ? (
                  <button
                    ...
                    className="text-[#ffffff] hover:text-[#6a14ff] flex items-center gap-2 font-mono text-[10px] tracking-widest uppercase"
                  >
                    <Cast size={16} /> Share
                  </button>
                ) : (
                  <button
                    ...
                    className="text-[#ffd100] hover:text-[#ffd100] flex items-center gap-2 font-mono text-[10px] tracking-widest uppercase"
                  >
                    <MonitorOff size={16} /> Stop
                  </button>
                )
              ) : (
                <span className={"font-mono text-[10px] tracking-widest uppercase " + (fullscreen ? "text-white/60" : "text-[#cccccc]")}>Guest</span>
              )}
              <div className="w-px h-8 bg-[#6a14ff]/15" />
              <button
                onClick={toggleMic}
                ...
                className={
                  ...
                  (micOn
                    ? (fullscreen ? "text-[#4cc9f0]" : "text-[#6a14ff]")
                    : (fullscreen ? "text-white/60 hover:text-white" : "text-[#cccccc] hover:text-[#ffffff]"))
                }
              >
              ...
              {canControl && voice.supported && (
                <button
                  ...
                  className={
                    ...
                    (voice.listening
                      ? (fullscreen ? "text-[#ffd100]" : "text-[#ffd100]")
                      : (fullscreen ? "text-white/60 hover:text-white" : "text-[#cccccc] hover:text-[#ffffff]"))
                  }
                >
                  <Radio size={16} />
                  {voice.listening && (
                    <span className="absolute -top-0.5 -right-0.5 w-2 h-2 rounded-full bg-[#ffd100] pulse-live" />
                  )}
                </button>
              )}
            </div>
            ...
            {fullscreen && chatOpenInFs && (
              <div className={
                ...
                <div className="flex-1 overflow-y-auto p-3 space-y-2">
                  {messages.map((m) => (
                    <div key={m.id} className={"border-l-2 pl-2 py-0.5 " + (m.sender_id === room.host_id ? "border-[#6a14ff]" : "border-[#4cc9f0]")}>
                      <div className="flex items-baseline gap-2">
                        <span className={"font-mono text-[10px] tracking-widest uppercase " + (m.sender_id === room.host_id ? "text-[#6a14ff]" : "text-[#4cc9f0]")}>
                          {m.sender_name}
                        </span>
                      </div>
                ...
                <form onSubmit={sendMessage} className="border-t border-white/10 p-2 flex gap-2">
                  ...
                  />
                  <button type="submit" className="bg-[#6a14ff] text-[#ffffff] px-2 py-1.5 hover:bg-[#5a0fd6]">
                    <Send size={14} />
                  </button>
                </form>
              </div>
          ...
          <aside className={
            ...
            " border border-[#6a14ff]/30 bg-white flex-col h-[55vh] sm:h-[62vh] lg:h-[78vh]"
          }>
            {/* Participants strip */}
            <div className="border-b border-[#6a14ff]/30 p-4">
              <div className="flex items-center gap-2 mb-3">
                <Users size={14} className="text-[#6a14ff]" />
                <span className="font-mono text-[10px] tracking-[0.3em] uppercase text-[#6a14ff]">
                  In the theatre · {presence.length}
                </span>
              </div>
                ...
                {presence.map((p) => {
                  ...
                  return (
                    <div key={p.id} className="flex flex-col items-center gap-1 shrink-0" title={p.name}>
                      <div className={`w-10 h-10 border ${room.host_id === p.id ? "border-[#6a14ff]" : "border-[#6a14ff]/30"} bg-[#2a2a2a] flex items-center justify-center font-head text-sm`}>
                        {m?.profile_image ? (
                      ...
                      <div className="font-mono text-[9px] tracking-widest uppercase text-[#cccccc] max-w-[64px] truncate">
                        {p.name}
                      </div>
                    </div>
                  );
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3" data-testid="chat-messages">
              {messages.map((m) => (
                <div
                  key={m.id}
                  className={`border-l-2 pl-3 py-1 ${m.sender_id === room.host_id ? "border-[#6a14ff]" : "border-[#4cc9f0]"}`}
                >
                  <div className="flex items-baseline gap-2">
                    <span className={`font-mono text-[10px] tracking-widest uppercase ${m.sender_id === room.host_id ? "text-[#6a14ff]" : "text-[#4cc9f0]"}`}>
                      {m.sender_name}
                  ...
                  <div className="text-[#ffffff] text-sm break-words">{m.text}</div>
                </div>
              ))}
              <div ref={chatEndRef} />
            </div>
            ...
            {/* Composer */}
            <form onSubmit={sendMessage} className="border-t border-[#6a14ff]/30 p-3">
              <div className="relative">
                {showEmoji && (
                  <div className="absolute bottom-12 left-0 right-0 bg-[#2a2a2a] border border-[#6a14ff]/30 p-2 grid grid-cols-9 gap-1 z-10">
                    {EMOJIS.map((e) => (
                      <button
                        key={e}
                        type="button"
                        onClick={() => setMsgText((t) => t + e)}
                        className="text-lg hover:bg-[#6a14ff]/10 rounded"
                      >{e}</button>
                    ))}
                  </div>
                )}
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="text-[#cccccc] hover:text-[#6a14ff] p-2"
                  >
                    <Smile size={18} />
                  </button>
                  <input
                    ...
                    className="flex-1 bg-[#2a2a2a] border border-[#6a14ff]/30 focus:border-[#ffd100] px-3 py-2 text-sm"
                  />
                  <button
                    type="submit"
                    data-testid="chat-send-button"
                    className="bg-[#6a14ff] text-[#ffffff] px-3 py-2 hover:bg-[#5a0fd6]"
                  >
                    <Send size={16} />
                  </button>
                </div>
      ...
      {showShareGuide && (
        <div
          className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-[#ffffff]/70 backdrop-blur-sm"
          data-testid="share-guide-modal"
          onClick={() => setShowShareGuide(false)}
        >
          <div
            className="w-full max-w-lg bg-white rounded-xl border border-[#6a14ff]/30 shadow-[0_30px_80px_rgba(0,0,0,0.7)] overflow-hidden"
          ...
          >
            ...
            <div className="p-5 space-y-3">
              ...
              <Step
                ...
                body={
                  <>
                    Select the tab playing <span className="font-mono text-[#6a14ff]">{PLATFORM_LABEL[room.platform]}</span> and tick
                    <span className="mx-1 px-1.5 py-0.5 bg-[#2a2a2a] border border-[#3a3a3a] rounded text-[11px] font-mono">Also share tab audio</span>.
                    Then hit Share.
                  </>
                }
              />
              <div className="mt-4 flex items-center gap-2 bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg p-3 text-[11px] text-[#cccccc]">
                <Info size={14} className="text-[#6a14ff] shrink-0" />
                <span>
                  <span className="font-semibold text-[#ffffff]">Why Tab, not Screen?</span> The "stop sharing" bar then lives only on the OTT tab — guests never see it, and your CinemaSync chat stays clean.
                </span>
              </div>
            </div>
            <div className="p-4 bg-[#2a2a2a] border-t border-[#3a3a3a] flex flex-wrap gap-2 justify-end">
              <button
                type="button"
                onClick={() => setShowShareGuide(false)}
                data-testid="share-guide-cancel"
                className="border border-[#6a14ff]/40 font-mono text-[10px] tracking-widest uppercase px-4 py-2 rounded-md hover:border-[#ffd100] hover:text-[#ffd100]"
              >
                Cancel
              </button>
              <button
                ...
                className="bg-[#ffd100] text-black font-mono text-[10px] tracking-widest uppercase px-4 py-2 rounded-md hover:shadow-[0_8px_20px_rgba(255,209,0,0.35)]"
              >
                Pick a tab →
              </button>
            </div>
...
function Step({ n, title, body }) {
  return (
    <div className="flex gap-3">
      <div className="w-7 h-7 rounded-full bg-[#6a14ff] text-white flex items-center justify-center font-mono text-[11px] font-semibold shrink-0">
        {n}
      </div>
      <div className="min-w-0">
        <div className="font-head text-sm uppercase text-[#ffffff]">{title}</div>
        <div className="text-[12px] text-[#cccccc] leading-relaxed mt-0.5">{body}</div>
      </div>
    </div>
  );
}
